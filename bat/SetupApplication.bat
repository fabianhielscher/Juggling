...
:: Android packaging
set AND_CERT_NAME="Juggling"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Juggling.p12
...
set IOS_PROVISION=cert\Juggling.mobileprovision
...
set APP_ID=air.Juggling

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Juggling
